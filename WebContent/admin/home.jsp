		...
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-left">
				<li class="layui-nav-item"><a href="javascript:;"
					onclick="refresh()">首页</a></li>
				<li class="layui-nav-item"><a href="javascript:;"
					onclick="timingOnclick('${pageContext.request.contextPath}/timingFormServlet',userid=${result.user.id})">定时设置</a></li>
				<li class="layui-nav-item"><a href="javascript:;"
					onclick="warnningOnclick('${pageContext.request.contextPath}/warnningMessageServlet',userid=${result.user.id})">报警<span
						class="layui-badge" id="warnning"></span></a></li>
			</ul>
			<ul class="layui-nav layui-layout-right">
				<li class="layui-nav-item"><a href="javascript:;"> <img
					...
					<dl id=demo class="layui-nav-child">
						<dd>
 							<a href="javascript:;" onclick="um('${pageContext.request.contextPath}/getUserMessageServlet?userid=${result.user.id}')">个人资料</a> 
						</dd>
					</dl></li>
				<li class="layui-nav-item"><a
					href="${pageContext.request.contextPath }/login1Servlet">退出登录</a></li>
			</ul>
		</div>
