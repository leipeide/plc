...
public class RecordDaoImpl implements RecordDao {
	...
	/*	return qr.update(
				...
				*/
		return qr.update(
				"INSERT INTO record (`date`, `deviceMac`, `nodeAddr`, `light1State`, `light2State`, `light1PowerPercent`, `light2PowerPercent`, `light1Power`, `light2Power`, `power`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
				record.getDate(), record.getDeviceMac(), record.getNodeAddr(), record.isLight1State(),
				record.isLight2State(), record.getLight1PowerPercent(), record.getLight2PowerPercent(),
				record.getLight1Power(), record.getLight2Power(), record.getPower());
	}
	...
	@Override
	public List<Record> selectTimeRangeNodePowerMessage(Date startDate,Date endDate) throws SQLException {
		QueryRunner qr = new QueryRunner(C3P0Utils.getDataSource());
