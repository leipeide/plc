...
<body>
	<div>
		<form class="layui-form"
			action="${pageContext.request.contextPath}/addNodesServlet?deviceid=${deviceid}"
			method="post">
			<div class="layui-form-item">
				<label class="layui-form-label">添加节点</label>
				<div class="layui-input-inline">
					<select id="selected" name="selected" lay-filter="Filter"
						style="width: 50px;">
			...
			<div class="layui-form-item">
				<div class="layui-input-block">
					<button name="nodeAddrBt" class="layui-btn layui-btn-sm">立即提交</button>
				</div>
			</div>
		</form>
	</div>
